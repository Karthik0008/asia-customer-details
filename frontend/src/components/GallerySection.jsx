            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {loading && (
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        {[1, 2, 3, 4, 5, 6].map((i) => (
                            <div key={i} className="aspect-square rounded-xl bg-ap-dark-card animate-shimmer" />
                        ))}
                    </div>
                )}
                ...
                {!loading && items.length > 0 && (
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 stagger">
                        {items.map((item, i) => (
                            <div
                                key={item.name}
                                className="group relative aspect-square rounded-xl overflow-hidden cursor-pointer animate-fadeInUp opacity-0"
